...
const onSubmit = async (data: PropertyFormValues) => {
  ...
  try {
    ...
    if (property) {
      ...
      try {
        // Try a different approach - use XMLHttpRequest instead of fetch
        const xhr = new XMLHttpRequest();
        xhr.open('POST', '/api/properties/create', true);
        ...
        // Send the request
        console.log('Sending XHR request with data:', JSON.stringify(propertyData));
        xhr.send(JSON.stringify(propertyData));

        // Wait for the response
        response = await xhrPromise;
        console.log('XHR Raw response from server:', response);
      } catch (fetchError) {
        console.error('XHR error:', fetchError);
        throw fetchError;
      }
    }
    if (response.ok) {
              ...
              <div className="flex flex-col sm:flex-row justify-between gap-4 mt-8">
                ...
                <div className="flex items-center gap-3 flex-wrap">
                  <Button
                    ...
                    variant="outline"
                    onClick={() => {
                      // Test if we can hit the test endpoint
                      ...
                      .then(data => {
                        ...
                        alert('Test endpoint response: ' + JSON.stringify(data));
                      })
                      .catch(error => {
                  ...
                  <Button
                    ...
                    onClick={() => {
                      ...
                      fetch('/api/test-create-property', {
                        method: 'GET',
                        credentials: 'include',
                      })
                      .then(response => response.json())
                      .then(data => {
                        console.log('Test property creation response:', data);
                        alert('Test property creation response: ' + JSON.stringify(data));
                        // Force a reload to see the new property
                        setTimeout(() => window.location.reload(), 1000);
                      })
                      .catch(error => {
                        console.error('Test property creation error:', error);
                        alert('Test property creation error: ' + error.message);
                      });
                    }}
                  >
                  ...
                  <Button
                    ...
                    onClick={() => {
                      ...
                      window.open('/api/property-form', '_blank');
                    }}
                  >
                    Open HTML Form
                  </Button>
                  ...
                  <Button
                    ...
                    onClick={() => {
                      ...
                      const fields = {
                        title: 'Direct Form Test Property',
                        description: 'This is a test property created via direct form submission.',
