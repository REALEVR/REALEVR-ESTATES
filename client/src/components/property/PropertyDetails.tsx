                  ...
                  <ul className="space-y-2 text-gray-500">
                    ...
                    {property.propertyCondition && (
                      <li className="flex items-center">
                        ...
                        <span>Condition: {property.propertyCondition.replace('-', ' ').replace(/\b\w/g, l => l.toUpperCase())}</span>
                      </li>
                    )}
                    {!property.yearOfConstruction && !property.buildingAge && !property.propertyCondition && (
                    ...
                    <ul className="space-y-2 text-gray-500">
                      {property.auctionStart && (
                        <li className="flex items-center">
                          ...
                          <span>Starts: {new Date(property.auctionStart).toLocaleDateString()}</span>
                        </li>
                      )}
                      {property.auctionEnd && (
                        <li className="flex items-center">
                          <i className="fas fa-stop w-6"></i>
                          <span>Ends: {new Date(property.auctionEnd).toLocaleDateString()}</span>
                        </li>
                      )}
                      {property.auctionStatus && (
                        <li className="flex items-center">
                          <i className="fas fa-gavel w-6"></i>
                          <span>Status: {property.auctionStatus.replace(/\b\w/g, l => l.toUpperCase())}</span>
                        </li>
                      )}
                      {!property.auctionStart && !property.auctionEnd && !property.auctionStatus && (
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between mb-8">
        <div className="mb-4 md:mb-0">
          <span className="text-2xl font-bold">
            {property.price !== undefined && property.price !== null ? property.price.toLocaleString() : 'N/A'} {property.currency || 'UGX'}
          </span>
