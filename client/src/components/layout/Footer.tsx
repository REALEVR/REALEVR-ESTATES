        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <ul className="space-y-2 text-gray-500">
              <li><Link href="/about" className="hover:text-[#FF5A5F]">About Us</Link></li>
              <li><Link href="/how-it-works" className="hover:text-[#FF5A5F]">How It Works</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-500">
              ...
              <li><Link href="/trust-safety" className="hover:text-[#FF5A5F]">Trust & Safety</Link></li>
            </ul>
          </div>
        </div>
