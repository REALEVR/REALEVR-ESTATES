...
export default function PropertyForm({ property, onSuccess }: PropertyFormProps) {
    ...
    return (
        <div className="space-y-6">
            <h1 className="text-2xl font-bold">{property ? 'Edit Property' : 'Create New Property'}</h1>
            <Tabs defaultValue="details" className="w-full">
                <TabsList className="grid w-full grid-cols-2">
                    <TabsTrigger value="details">Property etails</TabsTrigger>
                    <TabsTrigger value="tour" disabled={!property?.id}>
                        Virtual Tour
                    </TabsTrigger>
                </TabsList>
                        ...
                        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-6">
                                        ...
                                        <FormField
                                            ...
                                            render={({ field }) => (
                                                <FormItem>
                                                    ...
                                                    <FormDescription>
                                                        Enter size in square feet. This will be converted to square
                                                        meters for display.
                                                    </FormDescription>
                                                    <FormMessage />
                                                </FormItem>
                                    ...
                                    {/* --- NEW PROPERTY FIELDS --- */}
                                    {/* These fields are now moved to the top of the form */}
                                    {/* --- END NEW PROPERTY FIELDS --- */}
