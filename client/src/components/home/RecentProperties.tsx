...
export default function RecentProperties() {
  ...
  // Debug logging
  console.log('MostViewedProperties Debug:', {
    isLoadingProperties,
    isErrorProperties,
    allPropertiesCount: allProperties?.length || 0,
    mostViewedPropertiesCount: mostViewedProperties.length,
    mostViewedProperties: mostViewedProperties.slice(0, 3).map(p => ({ id: p.id, title: p.title, viewCount: p.viewCount || 0 }))
  });
  ...
  console.log('MostViewedProperties Detailed Debug:', {
    originalCount: mostViewedProperties.length,
    filteredCount: filteredProperties.length,
    isErrorProperties,
    filteredProperties: filteredProperties.slice(0, 3).map(p => ({ id: p.id, title: p.title, viewCount: p.viewCount || 0 }))
  });
  ...
  if (!filteredProperties || filteredProperties.length === 0) {
    console.log('MostViewedProperties: No properties to show');
    return (
      <div className="container mx-auto px-6 mt-10 mb-12">
