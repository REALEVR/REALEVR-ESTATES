  ...
  return (
    <AnimatePresence>
      <motion.a
        ...
        whileTap={{ scale: 0.95 }}
        className="fixed bottom-[var(--fab-row-1)] right-5 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg shadow-black/20 md:bottom-5"
      >
