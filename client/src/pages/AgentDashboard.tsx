  ...
  useEffect(() => {
    ...
    try {
      ...
      if (propertiesResponse.ok) {
        ...
        // Calculate stats
        const totalViews = agentProperties.reduce((sum: number, p: PropertyWithViews) => sum + (p.viewCount || 0), 0);
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="font-medium">
                          {property.currency} {property.price ? property.price.toLocaleString() : 'N/A'}
                        </span>
                      </div>
                      <div className="flex justify-between text-sm">
          ...
          <TabsContent value="tours" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Upload and manage virtual tours for your properties
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
