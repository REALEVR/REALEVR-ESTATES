                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="text-center mb-12">
                        ...
                        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                            ...
                            tours. Choose a subscription plan that fits your business needs.
                        </p>
                    </div>
                                ...
                                <CardContent>
                                    <Tabs value={selectedPlan} onValueChange={(value) => setSelectedPlan(value as any)}>
                                        ...
                                        <TabsContent value="basic" className="pt-4">
                                            <div
                                                className={`rounded-lg border-2 ${planDetails.basic.color} p-6 space-y-4`}
                                            >
                                                <div className="flex items-center justify-between">
                                                    <div>
                                                        <h3 className="text-xl font-bold">{planDetails.basic.name}</h3>
                                                        <Badge className={planDetails.basic.badgeColor}>
                                                            Popular for Starters
                                                        </Badge>
                                                    </div>
                                                    <div className="text-right">
                                                        <div className="text-3xl font-bold">
                                                            UGX {planDetails.basic.price.toLocaleString()}
                                                        </div>
                                                        <div className="text-sm text-gray-500">
                                                            per {planDetails.basic.period}
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <TabsContent value="professional" className="pt-4">
                                            <div
                                                className={`rounded-lg border-2 ${planDetails.professional.color} p-6 space-y-4`}
                                            >
                                                <div className="flex items-center justify-between">
                                                    <div>
                                                        <h3 className="text-xl font-bold">
                                                            {planDetails.professional.name}
                                                        </h3>
                                                        <Badge className={planDetails.professional.badgeColor}>
                                                            Most Popular
                                                        </Badge>
                                                    </div>
                                                    <div className="text-right">
                                                        <div className="text-3xl font-bold">
                                                            UGX {planDetails.professional.price.toLocaleString()}
                                                        </div>
                                                        <div className="text-sm text-gray-500">
                                                            per {planDetails.professional.period}
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <TabsContent value="enterprise" className="pt-4">
                                            <div
                                                className={`rounded-lg border-2 ${planDetails.enterprise.color} p-6 space-y-4`}
                                            >
                                                <div className="flex items-center justify-between">
                                                    <div>
                                                        <h3 className="text-xl font-bold">
                                                            {planDetails.enterprise.name}
                                                        </h3>
                                                        <Badge className={planDetails.enterprise.badgeColor}>
                                                            Premium
                                                        </Badge>
                                                    </div>
                                                    <div className="text-right">
                                                        <div className="text-3xl font-bold">
                                                            UGX {planDetails.enterprise.price.toLocaleString()}
                                                        </div>
                                                        <div className="text-sm text-gray-500">
                                                            per {planDetails.enterprise.period}
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                            <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
                                ...
                                <p className="text-gray-600 mb-4">
                                    You're about to register as a {selectedPlanDetails.name} for UGX{' '}
                                    {selectedPlanDetails.price.toLocaleString()} per month.
                                </p>
