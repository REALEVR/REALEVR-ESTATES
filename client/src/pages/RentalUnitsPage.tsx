    ...
    const sampleRentalUnits: Property[] = [
        {
            ...
            description:
                'Beautiful 2-bedroom apartment with modern finishes, security, and parking in the heart of Nakasero.',
        ...
        },
        {
            ...
            description:
                'Spacious 4-bedroom house with large garden, servant quarters, and ample parking in the prestigious Kololo area.',
        ...
        },
        {
            ...
            description:
                'Cozy studio apartment with essential amenities in a convenient location near shops and transport.',
        ...
        },
        {
            ...
            description:
                "Luxury 3-bedroom apartment with swimming pool, gym, and 24/7 security in Bugolobi's finest complex.",
            ...
            squareMeters: 1600,
            imageUrl:
                'https://images.unsplash.com/photo-1567496898669-ee935f5f647a?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=60',
            rating: '4.9',
            reviewCount: 31,
            propertyType: 'Apartment',
            category: 'rental_units',
        ...
        },
        {
            ...
            description:
                'Spacious 3-bedroom house on a large compound with fruit trees, perfect for families who want space and privacy.',
        ...
        },
        {
            ...
            description:
                'Cozy 1-bedroom apartment with city views, modern amenities, and convenient access to downtown Kampala.',
        ...
        <div className="py-8">
            ...
            <div className="container mx-auto px-6">
                ...
                {isLoading ? (
                    ...
                    <div>
                        <div className="mb-4 text-gray-500">Showing {sampleRentalUnits.length} sample properties</div>
